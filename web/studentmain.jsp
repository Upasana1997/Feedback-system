<%-- 
    ...
    Created on : May 17, 2018, 7:02:55 PM
    Author     : Dell
--%>
...
-->        <li><a href="#">Signed as ${get_username}</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <h3>Our key stake holders namely Students, Parents, Faculty, Alumni, Industry and Society as a whole, working in synergy towards a common goal which is the “Everlasting Success of Each Chitkara Student and creating them as responsible citizens”. </h3>
        </div>      
      </div>
    </div>
...
<!--            <a href="#" target="_blank">-->
              ...
              <div class="caption">
                <h3>Issues</h3>
                <p>Upload your issues as a feedback.</p>
                 <form name="f1">   
                    <input type="submit" class="btn btn-primary" value="Hostel" name="inh" style="margin-bottom:10px;" />
                    <input type="submit" class="btn btn-primary" value="Transportation" name="int" style="margin-bottom:10px;"/>
                    <input type="submit" class="btn btn-primary" value="Infrastructure" name="ini" style="margin-bottom:10px;"/>
                    <input type="submit" class="btn btn-primary" value="Others" name="ino" style="margin-bottom:10px;"/>
                    
                <c:if test="${param.inh!=null}">
...
<!--                <a href="#" target="_blank">-->
                  ...
                  <div class="caption">
                    <h3>Suggestion</h3>
                    <p>Upload your suggestions for the betterment of our system.</p>
                    <form name="f1">
                <input type="submit" class="btn btn-primary" value="Add Suggestion" name="b3"/>
...
<!--            <a href="#" target="_blank">-->
              ...
              <div class="caption">
                ...
                <p>Check the solutions provided by the admin to the feedback uploaded.</p>
               <form name="f1">
                <input type="submit" class="btn btn-primary" value="Check Status" name="b4"/>
...
<!--            <a href="#" target="_blank">-->
              ...
              <div class="caption">
                ...
                <p>Check the reply provided by the admin to the Suggestion uploaded.</p>
               <form name="f1">
                <input type="submit" class="btn btn-primary" value="Check Status" name="b5"/>
                    <c:if test="${param.b5!=null}">
