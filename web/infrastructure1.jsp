...
<%-- 
    Document   : infrastructure1
    Created on : May 18, 2018, 10:01:05 PM
    Author     : Dell
--%>
...
<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" 
     url="jdbc:mysql://localhost/practice" user="root" password=""></sql:setDataSource>
        ...
        <sql:query dataSource="${db}" var="rs">
         select * from tbissues where mid = ${md} and p_category = "infrastructure";
        </sql:query>
            ...
            <%
               ...
               if(request.getParameter("badmin")!=null)
               {
                  ...
                  // out.println(sname);
                   ...
                   pst1.setString(2,"infrastructure");
                   ResultSet rs;
