...
<%-- 
    Document   : admin_checkissue1
    Created on : May 18, 2018, 7:59:40 PM
    Author     : Dell
--%>
            ...
            <%
               if(request.getParameter("openform")!= null)
               {
                   ...
                   if(rs.next())
                   {
                       ...
                       out.println("<div class='form-group'>"+"<div class='col-md-2'><label>Issue category</label></div><div class='col-md-10'><input type='text' class='form-control' id='name' name='name' placeholder='Student ID' disabled required value='"+rs.getString("p_category")+"'/>" +"</div></div><br><br><br>" );
                       out.println("<div class='form-group'>"+"<div class='col-md-2'><label>Issue:</label></div><div class='col-md-10'><input type='text' class='form-control' id='aaaaa' name='name' placeholder='Issue' disabled required value='"+rs.getString("problem")+"'/>" +"</div></div><br><br><br>" );
                       ...
                       out.println("<div class='form-check'>"+"<div class='col-md-2'><input type='radio' name='r1'class='form-check-input' value='put in waiting'/>"+"<label>"+"Put in waiting"+"</label>"+"</div></div>");
                       out.println("<div class='form-check'>"+"<div class='col-md-2'><input type='radio' name='r1' class='form-check-input' value='Accepted'/>"+"<label>"+"Accepted"+"</label>"+"</div></div>");
                       ...
                       out.println("<div class='form-group'>"+"<div class='col-md-2'><label>Reply or Solution:</label></div><div class='col-md-10'><input type='text' class='form-control'name='ta1' id='name' name='name' placeholder='Student Name' required value='"+rs.getString("reply")+"'/>" +"</div></div><br><br><br>" );
