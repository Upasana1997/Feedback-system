...
<%-- 
    Document   : issueform1
    Created on : May 15, 2018, 3:15:38 PM
    Author     : Dell
--%>
  ...
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_fullname" id="id_2">
        <label class="form-label form-label-left" id="label_2" for="first_2"> Name </label>
        <div id="cid_2" class="form-input">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" id="first_2" name="q2_fullName[first]" class="form-textbox" size="20" value="${val2}" data-component="first" disabled />
              <label class="form-sub-label" for="first_2" id="sublabel_first" style="min-height:13px"> </label>
            </span>
      ...
      <li class="form-line" data-type="control_textbox" id="id_22">
        <label class="form-label form-label-left form-label-auto" id="label_22" for="input_22"> Roll No </label>
        <div id="cid_22" class="form-input">
          <input type="text" id="input_22" name="q22_rollNo" data-type="input-textbox" class="form-textbox" size="20" value="${val1}" data-component="textbox" disabled/>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_23">
        <label class="form-label form-label-left form-label-auto" id="label_23" for="input_23"> Category </label>
        <div id="cid_23" class="form-input">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_23" name="q23_category" data-type="input-textbox" class="form-textbox" size="20" value="${get_category}" data-component="textbox" disabled />
            <label class="form-sub-label" for="input_23" style="min-height:13px"> Hostel/ Transportation / Infrastructure/ Others </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_24">
        <label class="form-label form-label-left form-label-auto" id="label_24" for="input_24"> Mentor Id </label>
        <div id="cid_24" class="form-input">
          <input type="text" id="input_24" name="q24_mentorId" data-type="input-textbox" class="form-textbox" size="20" value="${val3}" data-component="textbox" disabled/>
        </div>
      </li>
